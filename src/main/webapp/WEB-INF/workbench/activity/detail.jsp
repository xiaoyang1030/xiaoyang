...
<body>
    ...
    <div class="modal fade" id="editActivityModal" role="dialog">
        <div class="modal-dialog" role="document" style="width: 85%;">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
                    <button type="button" class="btn btn-primary" onclick="editActivityBtn()" data-dismiss="modal">更新</button>
                </div>
            </div>
        </div>
    </div>
	...
	<div style="position: relative; left: 40px; top: -30px;">
		...
		<div style="position: relative; height: 50px; width: 250px;  top: -72px; left: 700px;">
			<button type="button" onclick="editBtn('${activity.id}')" class="btn btn-default" data-toggle="modal" data-target="#editRemarkModal"><span class="glyphicon glyphicon-edit"></span> 编辑</button>
	...
	<div style="position: relative; top: 30px; left: 40px;">
		...
		<c:forEach items="${activity.activityRemark}" var="activityRemark">
			<!-- 备注1 -->
			<div id="div" class="remarkDiv" style="height: 60px;">
				...
				<div  style="position: relative; top: -40px; left: 40px;" >
					...
					<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">
						<a class="myHref" onclick="editActivityRemark()" data-toggle="modal" data-target="#editActivityModal" href="javascript:void(0);"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: #E6E6E6;"></span></a>
						&nbsp;&nbsp;&nbsp;&nbsp;
						<a class="myHref" onclick="delActivityRemark('${activityRemark.id}')" href="javascript:void(0);"><span class="glyphicon glyphicon-remove" style="font-size: 20px; color: #E6E6E6;"></span></a>
					</div>
				</div>
			</div>
		</c:forEach>
		<div id="remarkDiv" style="background-color: #E6E6E6; width: 870px; height: 90px;">
			<form role="form" style="position: relative;top: 10px; left: 10px;">
				...
				<p id="cancelAndSaveBtn" style="position: relative;left: 737px; top: 10px; display: none;">
					...
					<button type="button" onclick="createActivityRemark($('#remark').val())" class="btn btn-primary">保存</button>
				</p>
			</form>
		</div>
	</div>
